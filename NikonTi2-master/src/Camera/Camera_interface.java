...
public class Camera_interface {
    ...
    private JFrame LasermainFrame = new JFrame("Camera Script");
    ...
    public void setupCameraInterface(Studio app) {
        ...
        JPanel camerarunPanel = new JPanel();
        ...
        camerarunPanel.add(enterButton);
        ...
        LasermainFrame.getContentPane().add(camerarunPanel, constraints);
