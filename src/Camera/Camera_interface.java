...
public class Camera_interface {
    ...
    private JFrame CameramainFrame = new JFrame("Camera Script");
    private GridBagConstraints constraints = new GridBagConstraints();
    private JPanel tablePanel = new JPanel(new GridLayout(0, 1));

    //Initializing final entry class
    private CameraScript mousecontroller;


    public void setupCameraInterface(Studio app) {
        //Setting up behavior of the main frame
        CameramainFrame.setLayout(new GridBagLayout());
        CameramainFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        CameramainFrame.setSize(400, 300);

        //Setting up core components
        gui = (MMStudio) app;
        core = gui.getCMMCore();
        //mousecontroller = new CameraScript(core);


        //Setting up title panel
        JPanel titlePanel = new JPanel();
        JLabel titleLabel = new JLabel("Camera Control");
        ...
        constraints.gridy = 1;
        constraints.gridx = 5;
        CameramainFrame.getContentPane().add(titlePanel, constraints);
        ...
        CameramainFrame.getContentPane().add(laserrunPanel, constraints);

        CameramainFrame.setVisible(true);
    }
