...
public class LEDConfig1 extends JPanel{
    ...
    protected ArrayList<JTextField> ledIntensityInfo = new ArrayList<JTextField>();

    public LEDConfig1(AcquisitionData acquisitionData, ArrayList<ArrayList<JTextField>> pointInformation) {
